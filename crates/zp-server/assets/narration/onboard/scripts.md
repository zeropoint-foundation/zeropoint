...
Your sovereignty boundary is the line between authorized and unauthorized. In the old model, that line was drawn by someone else — a corporate SSO, an OAuth provider, a certificate authority. You trusted their infrastructure to prove you were you. ZeroPoint flips that. You choose the credential. A fingerprint, a hardware key, a face, or a login password — something that can't be phished, can't be copied, and can't be faked by a process running on your machine. A Trezor on your desk or Touch ID on your laptop — the form factor changes, but the principle doesn't. You prove presence. ZeroPoint trusts the proof. This is the foundation. Everything else — your vault, your policies, your agent certificates — derives from this one decision.
