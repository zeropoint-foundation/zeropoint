...
Command-line interface for ZeroPoint. Provides interactive chat, local-first command security evaluation (Guard), mesh network management, and system health commands.
