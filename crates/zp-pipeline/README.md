...
Central orchestrator for ZeroPoint — wires policy evaluation, LLM interaction, skill matching, audit logging, and mesh networking into a single request-handling flow.
