...
./v2/tests/reticulum/run_test.sh --load 100
```
...
python3 v2/tests/reticulum/zp_agent_bridge.py <DESTINATION_HASH>

# With options:
python3 v2/tests/reticulum/zp_agent_bridge.py <DEST> -n 10 --load-test 200 -d 0.2
```
