...
- **EXECUTION-AUTHORITY-MODEL-2026-07.md** Phase 5 — model dossier's evidence-backed fields (doom-loop rate, entropy baseline, task-class triggers) become eval-battery targets for substrate-specific fine-tunes.
