...
**Touches:** KEEL Part XIV.5 (Inference Sourcing) and the glossary *inference-sourcing* axis (local / rallied / cloud); `INFERENCE-ROUTING-DISCIPLINE-2026-07`; `EXECUTION-AUTHORITY-MODEL-2026-07` Phase 5 (model dossiers); `SUBSTRATE-SLM-TRAINING-ENVIRONMENT-2026-07`; `REGENT-DOOM-LOOP-DETECTION-2026-07`.
